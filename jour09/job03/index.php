<?php
    ...
    // Récupération des informations de la table "étudiants" à l'aide d'une requête SQL
    $reponse = $bdd->query('SELECT prenom, nom, naissance FROM etudiants WHERE sexe = "F"');
